        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('penggeledahans.update', $penggeledahan->id) }}" method="POST"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('rupam') is-invalid @enderror"
                                    name="rupam" value="{{ old('rupam', $penggeledahan->rupam) }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control @error('blok') is-invalid @enderror" name="blok"
                                    id="blok">
                                    <option value="">Pilih Blok</option>
                                    <option value="Wisma Anggrek"
                                        {{ old('blok', $penggeledahan->blok) == 'Wisma Anggrek' ? 'selected' : '' }}>Wisma
                                        Anggrek</option>
                                    <option value="Wisma Bugenvil"
                                        {{ old('blok', $penggeledahan->blok) == 'Wisma Bugenvil' ? 'selected' : '' }}>Wisma
                                        Bugenvil</option>
                                    <option value="Wisma Cluadia"
                                        {{ old('blok', $penggeledahan->blok) == 'Wisma Cluadia' ? 'selected' : '' }}>Wisma
                                        Cluadia</option>
                                    <option value="Wisma Edelweis"
                                        {{ old('blok', $penggeledahan->blok) == 'Wisma Edelweis' ? 'selected' : '' }}>Wisma
                                        Edelweis</option>
                                    <option value="Wisma Flamboyan"
                                        {{ old('blok', $penggeledahan->blok) == 'Wisma Flamboyan' ? 'selected' : '' }}>Wisma
                                        Flamboyan</option>
                                    <option value="Wisma Dahlia"
                                        {{ old('blok', $penggeledahan->blok) == 'Wisma Dahlia' ? 'selected' : '' }}>Wisma
                                        Dahlia</option>
                                </select>
                                @error('blok')
                                    <div class="alert alert-danger mt-2">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('kamar') is-invalid @enderror"
                                    name="kamar" value="{{ old('kamar', $penggeledahan->kamar) }}"
                                    placeholder="ex: Kamar 1 dan 2">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                    id="tanggal" name="tanggal" value="{{ old('tanggal', $penggeledahan->tanggal) }}"
                                    placeholder="Masukkan Judul Product">
                                @error('tanggal')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="time" id="jam_mulai"
                                            ...
                                            value="{{ old('jam_mulai', $penggeledahan->jam_mulai) }}"
                                            placeholder="Masukkan Judul Product">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="time" id="jam_akhir"
                                            class="form-control @error('jam_akhir') is-invalid @enderror" name="jam_akhir"
                                            value="{{ old('jam_akhir', $penggeledahan->jam_akhir) }}"
                                            placeholder="Masukkan Judul Product">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('petugas') is-invalid @enderror"
                                    name="petugas" value="{{ old('petugas', $penggeledahan->petugas) }}"
                                    placeholder="Masukkan Judul Product">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('sajam') is-invalid @enderror"
                                    id="sajam" name="sajam" value="{{ old('sajam', $penggeledahan->sajam) }}"
                                    placeholder="Masukkan Judul Product">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('hp') is-invalid @enderror" id="hp"
                                    name="hp" value="{{ old('hp', $penggeledahan->hp) }}"
                                    placeholder="Masukkan Judul Product">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('narkoba') is-invalid @enderror"
                                    id="narkoba" name="narkoba" value="{{ old('narkoba', $penggeledahan->narkoba) }}"
                                    placeholder="Masukkan Judul Product">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('hasil_razia') is-invalid @enderror" name="hasil_razia"
                                    placeholder="Masukkan hasil razia">{{ old('hasil_razia', $penggeledahan->hasil_razia) }}</textarea>
                                ...
                                <script>
                                    function getKeterangan() {
                                        ...
                                        if (sajam == "NIHIL" || hp == "NIHIL" || narkoba == "NIHIL") {
                                            document.getElementById("hasil_razia").innerHTML =
                                                "1 Tidak ada barang bukti hasil razia/ sidak dan pemeriksaan instalasi listrik diinventarisir dan didata. 2. Tidak ada barang bukti hasil razia/ sidak dan pemeriksaan instalasi listrik diamankan / dimusnahkan.";
                                        } else {
                                            document.getElementById("hasil_razia").innerHTML =
                                                "1.Barang bukti hasil razia/ sidak dan pemeriksaan instalasi listrik diinventarisir dan didata. 2. Barang bukti hasil razia/ sidak dan pemeriksaan instalasi listrik diamankan / dimusnahkan.";
                                        }
                                    }
                                </script>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div id="imagePreview1" class="mt-3">
                                    @if ($penggeledahan->image_1)
                                        <img src="{{ asset('/storage/penggeledahans/' . $penggeledahan->image_1) }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div id="imagePreview2" class="mt-3">
                                    @if ($penggeledahan->image_2)
                                        <img src="{{ asset('/storage/penggeledahans/' . $penggeledahan->image_2) }}"
                                            class="rounded" style="width: 200px">
                                    @endif
                                </div>
                                @error('image_2')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div id="imagePreview3" class="mt-3">
                                    @if ($penggeledahan->image_3)
                                        <img src="{{ asset('/storage/penggeledahans/' . $penggeledahan->image_3) }}"
                                            class="rounded" style="width: 200px">
                                    @endif
                                </div>
                                @error('image_3')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div id="imagePreview4" class="mt-3">
                                    @if ($penggeledahan->image_4)
                                        <img src="{{ asset('/storage/penggeledahans/' . $penggeledahan->image_4) }}"
                                            class="rounded" style="width: 200px">
                                    @endif
                                </div>
                                @error('image_4')
