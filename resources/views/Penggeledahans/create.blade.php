                        ...
                        <form action="{{ route('penggeledahans.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('rupam') is-invalid @enderror"
                                    name="rupam" value="{{ old('rupam') }} {{ Auth::user()->rupam }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control @error('blok') is-invalid @enderror" name="blok"
                                    ...
                                    <option value="Wisma Anggrek" {{ old('blok') == 'Wisma Anggrek' ? 'selected' : '' }}>
                                        Wisma Anggrek</option>
                                    <option value="Wisma Bugenvil" {{ old('blok') == 'Wisma Bugenvil' ? 'selected' : '' }}>
                                        Wisma Bugenvil</option>
                                    <option value="Wisma Cluadia" {{ old('blok') == 'Wisma Cluadia' ? 'selected' : '' }}>
                                        Wisma Cluadia</option>
                                    <option value="Wisma Edelweis" {{ old('blok') == 'Wisma Edelweis' ? 'selected' : '' }}>
                                        Wisma Edelweis</option>
                                    <option value="Wisma Flamboyan"
                                        {{ old('blok') == 'Wisma Flamboyan' ? 'selected' : '' }}>Wisma Flamboyan</option>
                                    <option value="Wisma Dahlia" {{ old('blok') == 'Wisma Dahlia' ? 'selected' : '' }}>Wisma
                                        Dahlia</option>
                                </select>
                                @error('blok')
                                    <div class="alert alert-danger mt-2">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('kamar') is-invalid @enderror"
                                    name="kamar" value="{{ old('kamar') }}" placeholder="ex: Kamar 1 dan 2">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="time" id="jam_mulai"
                                            ...
                                            value="{{ old('jam_mulai') }}" placeholder="Masukkan Judul Product">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="time" id="jam_akhir"
                                            ...
                                            value="{{ old('jam_akhir') }}" placeholder="Masukkan Judul Product">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('petugas') is-invalid @enderror"
                                    name="petugas" value="Ka.Rupam , Waka.Rupam, Anggota Jaga"
                                    placeholder="Masukkan Judul Product">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('sajam') is-invalid @enderror"
                                    id="sajam" name="sajam" value="NIHIL" placeholder="Masukkan Judul Product">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('hp') is-invalid @enderror" id="hp"
                                    name="hp" value="NIHIL" placeholder="Masukkan Judul Product">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('narkoba') is-invalid @enderror"
                                    id="narkoba" name="narkoba" value="NIHIL" placeholder="Masukkan Judul Product">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('hasil_razia') is-invalid @enderror" name="hasil_razia"
                                    placeholder="Masukkan hasil razia">NIHIL</textarea>
