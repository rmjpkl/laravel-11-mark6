            ...
            <div class="card-body">
                ...
                <div style="overflow-x:auto;">
                    <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
                        width="100%">
                        <a href="{{ route('trollings.create') }}" class="btn btn-md btn-success mb-5 btn-block"><i
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                            action="{{ route('trollings.destroy', $trolling->id) }}" method="POST">
                                            <a href="{{ route('trollings.show', $trolling->id) }}"
