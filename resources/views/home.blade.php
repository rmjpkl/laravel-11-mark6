        ...
        <div class="row">
          ...
          <div class="col-6 col-sm-3">
            <div class="card bg-primary text-white mb-4 text-center">
              ...
              <div class="card-footer d-flex justify-content-center"><a class="small text-white stretched-link text-decoration-none fs-7 text-center" href="{{ route('penggeledahans.index') }}">Penggeledahan</a></div>
            </div>
          </div> 
